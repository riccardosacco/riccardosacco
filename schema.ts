...
export interface Experience {
	...
	icon?: DirectusFile | string | null;
	link?: string | null;
	employment_type?: `full-time` | `part-time` | `self-employed` | 'freelance' | 'intership' | 'apprenticeship' | 'seasonal' | null;
	location_type?: `on-site` | 'hybrid' | 'remote' | null;
	description?: string | null;
	resume?: Resume | string | null;
	company_parent?: Experience | string | null;
}
...
export interface Skill {
	...
	resume?: Resume | string | null;
	icon?: DirectusFile | string | null;
	type?: 'technical' | 'professional' | `AI/ML` | `Software Engineering` | `DevOps & Cloud` | null;
}
