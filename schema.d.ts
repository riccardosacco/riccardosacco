...
export interface paths {
  ...
  "/items/experiences": {
    /**
     * List Items
     * @description List the experiences items.
     */
    get: operations["readItemsExperiences"];
    /**
     * Create an Item
     * @description Create a new experiences item.
     */
    post: operations["createItemsExperiences"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing experiences items.
     */
    delete: operations["deleteItemsExperiences"];
    /**
     * Update Multiple Items
     * @description Update multiple experiences items at the same time.
     */
    patch: operations["updateItemsExperiences"];
  };
  "/items/experiences/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single experiences item by unique identifier.
     */
    get: operations["readSingleItemsExperiences"];
    /**
     * Delete an Item
     * @description Delete an existing experiences item.
     */
    delete: operations["deleteSingleItemsExperiences"];
    /**
     * Update an Item
     * @description Update an existing experiences item.
     */
    patch: operations["updateSingleItemsExperiences"];
  };
  "/items/education": {
    /**
     * List Items
     * @description List the education items.
     */
    get: operations["readItemsEducation"];
    /**
     * Create an Item
     * @description Create a new education item.
     */
    post: operations["createItemsEducation"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing education items.
     */
    delete: operations["deleteItemsEducation"];
    /**
     * Update Multiple Items
     * @description Update multiple education items at the same time.
     */
    patch: operations["updateItemsEducation"];
  };
  "/items/education/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single education item by unique identifier.
     */
    get: operations["readSingleItemsEducation"];
    /**
     * Delete an Item
     * @description Delete an existing education item.
     */
    delete: operations["deleteSingleItemsEducation"];
    /**
     * Update an Item
     * @description Update an existing education item.
     */
    patch: operations["updateSingleItemsEducation"];
  };
  "/items/languages": {
    /**
     * List Items
  ...
  "/items/resume": {
    /**
     * List Items
     * @description List the resume items.
     */
    get: operations["readItemsResume"];
    /**
     * Create an Item
     * @description Create a new resume item.
     */
    post: operations["createItemsResume"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing resume items.
     */
    delete: operations["deleteItemsResume"];
    /**
     * Update Multiple Items
     * @description Update multiple resume items at the same time.
     */
    patch: operations["updateItemsResume"];
  };
  "/items/resume/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single resume item by unique identifier.
     */
    get: operations["readSingleItemsResume"];
    /**
     * Delete an Item
     * @description Delete an existing resume item.
     */
    delete: operations["deleteSingleItemsResume"];
    /**
     * Update an Item
     * @description Update an existing resume item.
     */
    patch: operations["updateSingleItemsResume"];
  };
  "/items/projects": {
    /**
     * List Items
  ...
  "/items/cover_letters": {
    /**
     * List Items
     * @description List the cover_letters items.
     */
    get: operations["readItemsCoverLetters"];
    /**
     * Create an Item
     * @description Create a new cover_letters item.
     */
    post: operations["createItemsCoverLetters"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing cover_letters items.
     */
    delete: operations["deleteItemsCoverLetters"];
    /**
     * Update Multiple Items
     * @description Update multiple cover_letters items at the same time.
     */
    patch: operations["updateItemsCoverLetters"];
  };
  "/items/cover_letters/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single cover_letters item by unique identifier.
     */
    get: operations["readSingleItemsCoverLetters"];
    /**
     * Delete an Item
     * @description Delete an existing cover_letters item.
     */
    delete: operations["deleteSingleItemsCoverLetters"];
    /**
     * Update an Item
     * @description Update an existing cover_letters item.
     */
    patch: operations["updateSingleItemsCoverLetters"];
  };
  "/extensions": {
    /**
     * List Extensions
  ...
  "/items/certifications": {
    /**
     * List Items
     * @description List the certifications items.
     */
    get: operations["readItemsCertifications"];
    /**
     * Create an Item
     * @description Create a new certifications item.
     */
    post: operations["createItemsCertifications"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing certifications items.
     */
    delete: operations["deleteItemsCertifications"];
    /**
     * Update Multiple Items
     * @description Update multiple certifications items at the same time.
     */
    patch: operations["updateItemsCertifications"];
  };
  "/items/certifications/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single certifications item by unique identifier.
     */
    get: operations["readSingleItemsCertifications"];
    /**
     * Delete an Item
     * @description Delete an existing certifications item.
     */
    delete: operations["deleteSingleItemsCertifications"];
    /**
     * Update an Item
     * @description Update an existing certifications item.
     */
    patch: operations["updateSingleItemsCertifications"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsExperiences: {
      ...
      description?: string | null;
      resume?: string | components["schemas"]["ItemsResume"] | null;
    };
    ItemsEducation: {
      /** Format: uuid */
      id: string;
    ...
    ItemsResume: {
      ...
      experiences?: ((string | components["schemas"]["ItemsExperiences"])[]) | null;
      education?: ((string | components["schemas"]["ItemsEducation"])[]) | null;
      languages?: ((string | components["schemas"]["ItemsLanguages"])[]) | null;
      projects?: ((string | components["schemas"]["ItemsProjects"])[]) | null;
      skills?: ((string | components["schemas"]["ItemsSkills"])[]) | null;
      social?: ((string | components["schemas"]["ItemsSocial"])[]) | null;
      certifications?: ((string | components["schemas"]["ItemsCertifications"])[]) | null;
    };
    ItemsProjects: {
      /** Format: uuid */
      id: string;
...
export interface operations {
  ...
  readItemsExperiences: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsExperiences"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsExperiences: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsExperiences"][] | components["schemas"]["ItemsExperiences"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsExperiences: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsExperiences"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsEducation: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsEducation"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsEducation: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEducation"][] | components["schemas"]["ItemsEducation"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsEducation: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEducation"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsResume: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsResume"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsResume: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsResume"][] | components["schemas"]["ItemsResume"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsResume: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsResume"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsCoverLetters: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCoverLetters"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsCoverLetters: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCoverLetters"][] | components["schemas"]["ItemsCoverLetters"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsCoverLetters: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCoverLetters"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsCertifications: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCertifications"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsCertifications: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCertifications"][] | components["schemas"]["ItemsCertifications"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description Delete an existing certifications item.
   */
  deleteSingleItemsCertifications: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing certifications item.
   */
  updateSingleItemsCertifications: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCertifications"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type Schema = {
  experiences: components["schemas"]["ItemsExperiences"][];
  education: components["schemas"]["ItemsEducation"][];
  languages: components["schemas"]["ItemsLanguages"][];
  resume: components["schemas"]["ItemsResume"][];
  projects: components["schemas"]["ItemsProjects"][];
  skills: components["schemas"]["ItemsSkills"][];
  cover_letters: components["schemas"]["ItemsCoverLetters"][];
  social: components["schemas"]["ItemsSocial"][];
  certifications: components["schemas"]["ItemsCertifications"][];
};
